CLASS zcl_customer_provider2 DEFINITION
  PUBLIC
  FINAL
  CREATE PRIVATE
  GLOBAL FRIENDS zcl_customer_provider_factory2 .

  PUBLIC SECTION.
    INTERFACES zif_customer_provider2 .
  ...
  PRIVATE SECTION.
    ...
    DATA customer_data TYPE zif_customer_provider2=>customer_type.
...
CLASS zcl_customer_provider2 IMPLEMENTATION.
  ...
  METHOD zif_customer_provider2~get_node_key.
    node_key = me->customer_data-node_key.
  ENDMETHOD.

  METHOD zif_customer_provider2~get_bp_id.
    bp_id = me->customer_data-bp_id.
  ENDMETHOD.

  METHOD zif_customer_provider2~get_company_name.
    company_name = me->customer_data-company_name.
  ENDMETHOD.

  METHOD zif_customer_provider2~get_street.
    street = me->customer_data-street.
  ENDMETHOD.

  METHOD zif_customer_provider2~get_city.
    city = me->customer_data-city.
  ENDMETHOD.

  METHOD zif_customer_provider2~get_postal_code.
    postal_code = me->customer_data-postal_code.
  ENDMETHOD.

  METHOD zif_customer_provider2~get_country.
    country = me->customer_data-country.
  ENDMETHOD.

  METHOD zif_customer_provider2~get_country_text.
    TRY.
