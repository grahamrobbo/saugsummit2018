CLASS zcl_customer2 DEFINITION
  PUBLIC
  CREATE PROTECTED .
  ...
  PROTECTED SECTION.
    ...
    DATA: customer_provider TYPE REF TO zif_customer_provider2.
...
CLASS zcl_customer2 IMPLEMENTATION.
  ...
  METHOD zif_customer~get.
    ...
    TRY.
      ...
      CATCH cx_sy_itab_line_not_found.
        ...
        inst-instance = NEW zcl_customer2( inst-node_key ).
  ...
  METHOD zif_customer~get_using_bp_id.
    instance = zif_customer~get( zcl_customer_provider_factory2=>get_node_key_from_bp_id( bp_id ) ).
  ENDMETHOD.

  METHOD constructor.
    customer_provider ?= zcl_customer_provider_factory2=>get_customer_provider( node_key ).
  ENDMETHOD.
